...
export function SuccessNotice({ title, description }: SuccessNoticeProps) {
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed left-1/2 top-6 z-50 flex w-[calc(100vw-48px)] max-w-[408px] -translate-x-1/2 items-center gap-3 rounded-lg border border-green-300 bg-white px-[18px] py-4 shadow-[0_18px_42px_-24px_rgba(15,23,42,0.22)] sm:top-[108px]"
    >
